...
class Program
{
    public static void Main(String[] args)
    {
        ...
        Officer officer6 = new Officer(
            "Norman", "Blair", "District 3", 6, 35);

        Officer officer7 = new Officer(
            "Brenda", "Romero", "District 3", 7, 30);

        District district1 = new District("D 1",
            "Riga", 1);
        District district2 = new District("D 2",
            "Vilnus", 2);

        District district3 = new District("D 3",
            "Kaunas", 3);
        ...
        Console.WriteLine("District in" + district2.City + "has an avarege level of" + district2.AverageLevel);
